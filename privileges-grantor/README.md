...
| metastore\_events\_sns\_filter | SNS filter of message attributes to the added to the sns sns topic subscription. Supported format: SNS filter format | string | `{ "eventType": [ "CREATE_TABLE", "ALTER_TABLE" ] }` | no |
